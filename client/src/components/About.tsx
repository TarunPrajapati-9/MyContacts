  ...
  return (
    <div className="bg-[#FFFFFF]">
      ...
      <div className="mt-4">
        ...
        <p className="font-aboutDesc text-justify font-semibold p-8 text-3xl mx-auto max-w-screen-md">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-6 md:mb-0">
            <img
              src="/developer.png"
              alt="developer"
              className="w-3/4 md:w-full max-w-xs md:max-w-full"
            />
          </div>
          <div className="w-full md:w-1/2 md:my-20">
            <p className="font-aboutDesc text-justify font-semibold p-10 md:text-3xl text-2xl">
            ...
            <div className="flex gap-6 justify-center mb-4 cursor-pointer">
